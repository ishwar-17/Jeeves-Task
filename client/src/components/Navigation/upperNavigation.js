            ...
            <div className="upperNavigation">
                <div className="screen-container">
                    <Navbar expand="lg" className="navbar-section">
                        <Navbar.Brand as={Link} to="/"><AiFillHome/> {this.props.brandName}</Navbar.Brand>
                        <Navbar.Toggle aria-controls="basic-navbar-nav"/>
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="mx-auto upper-navbar-link">
                                <Nav.Item className="navabr-item"><NavLink className="navbar-link mr-lg-14 ml-lg-14 nav-link-class" to="/" exact activeClassName="active">All property</NavLink></Nav.Item>
                            </Nav>
